    ...
    return Column(
      ...
      children: [
        ...
        Text("We got you covered!",
            ...
            style: GoogleFonts.poppins(
                textStyle:
                    TextStyle(fontSize: 25.sp, color: HexColor("#0E131F")))),
        Padding(
            ...
            children: [
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border:
                          Border.all(width: 10.w, color: HexColor("#AAA1C8")),
                      borderRadius: const BorderRadius.all(Radius.circular(5)),
                    ),
                  ),
                  SizedBox(width: 2.w),
                  Text(
                      "View and learn the different\nelements in the periodic table",
              ...
              Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                        "Solve quizzes to better understand the materials and test your knowledge",
                        textAlign: TextAlign.start,
                        style: GoogleFonts.poppins(
                            textStyle: TextStyle(
                                fontSize: 12.sp, color: HexColor("#0E131F")))),
